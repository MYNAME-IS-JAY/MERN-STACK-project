...
const Hero = () => {
  return (
    <div className='px-5 xl:px-10 md:w-1/2 mb-10'>
      <h1 className='mt-6 mb-10 text-5xl x1:text-6x1 text-center font-bold text-[#2A3342] leading-normal x1:leading-relaxed'>A blog template made for food <span  className='text-orange-400'>influencers</span></h1>         
