  ...
  return (
    <div className='container mx-auto flex justify-center md:justify-start'>
       <div className='max-w-sm '>
           <div className='bg-white flex flex-col justify-between relative shadow-lg hover:shadow-xl transition duration-500 rounded-lg h-[400px]'>
               ...
               <div className='py-6 px-5 rounded-lg bg-white'>
                ...
                <div className='absolute top-2 right-2 py-2 px-4 bg-white rounded-lg'>
                    <span className='front-medium'>{item?.more[0].difficulty}</span>
